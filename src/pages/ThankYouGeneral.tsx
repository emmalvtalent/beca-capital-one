...
export function ThankYouGeneral() {
...
END:VCALENDAR`;
  ...
  useEffect(() => {
    // Update page title
    document.title = 'Solicitud Recibida | Rueda de Prensa Talent Land 2026';
  }, []);
        ...
        <div className="max-w-2xl w-full">
          <div className="text-center mb-12 animate-slide-up">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
              ¡Gracias por tu interés para asistir a la Rueda de Prensa!
            </h1>
            
            <p className="text-gray-400 text-lg mb-2">
              Hemos recibido tu solicitud y te confirmaremos tu asistencia en los próximos días.
            </p>
